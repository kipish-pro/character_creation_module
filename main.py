...
def attack(char_name: str, char_class: str) -> str:
    """Make description results of attak."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} сплоховал в бою')


def defence(char_name: str, char_class: str) -> str:
    """Make description result of blocking in fight."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} тебе блокировать разве что веник бабушки')


def special(char_name: str, char_class: str) -> str:
    """Make description used special skills."""
    if char_class == 'warrior':
